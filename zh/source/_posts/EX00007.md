...
当时没有在逆向解码函数的路上走太远...<!--准确说，看见里面的某个不确定数组以后就放弃了，-->没想到真能单独拿出来跑。
